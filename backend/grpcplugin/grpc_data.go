...
func (s *dataGRPCServer) QueryChunkedData(req *pluginv2.ChunkedDataRequest, stream grpc.ServerStreamingServer[pluginv2.ChunkedDataResponse]) error {
...
func (m *dataGRPCClient) QueryChunkedData(ctx context.Context, in *pluginv2.ChunkedDataRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[pluginv2.ChunkedDataResponse], error) {
